...
<div class="agregar_inventario">
	...
	echo '  ';
	echo $this->Html->link('Agregar nueva materia prima',array('controller' => 'materiasprimasmoldes','action' => 'admin_editar'),array('class'=>'boton'));
	echo '<br>';
	?>
</div>
...
<?php 
	if (!empty($materiasprima)) {
		echo $this->element('admin_inventario_moldes');
	}
?>
</div>
